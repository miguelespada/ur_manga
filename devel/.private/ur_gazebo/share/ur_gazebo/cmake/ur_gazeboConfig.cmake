...
if("TRUE" STREQUAL "TRUE")
  set(ur_gazebo_SOURCE_PREFIX /home/miguel/ws_moveit/src/universal_robot/ur_gazebo)
  set(ur_gazebo_DEVEL_PREFIX /home/miguel/ws_moveit/devel/.private/ur_gazebo)
  ...
  set(ur_gazebo_INSTALL_PREFIX /home/miguel/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/miguel/ws_moveit/src/universal_robot/ur_gazebo/${idir}'.  Ask the maintainer 'Felix Messmer <fxm@ipa.fhg.de>, G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/miguel/ws_moveit/devel/.private/ur_gazebo/lib;/home/miguel/ws_moveit/devel/lib;/opt/ros/kinetic/lib)
