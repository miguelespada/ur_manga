...
if("TRUE" STREQUAL "TRUE")
  set(pr2_description_SOURCE_PREFIX /home/miguel/ws_moveit/src/pr2_common/pr2_description)
  set(pr2_description_DEVEL_PREFIX /home/miguel/ws_moveit/devel/.private/pr2_description)
  ...
  set(pr2_description_INSTALL_PREFIX /home/miguel/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/miguel/ws_moveit/src/pr2_common/pr2_description/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/miguel/ws_moveit/devel/.private/pr2_description/lib;/home/miguel/ws_moveit/devel/lib;/opt/ros/kinetic/lib)
