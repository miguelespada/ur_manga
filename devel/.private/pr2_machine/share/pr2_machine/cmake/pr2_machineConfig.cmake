...
if("TRUE" STREQUAL "TRUE")
  set(pr2_machine_SOURCE_PREFIX /home/miguel/ws_moveit/src/pr2_common/pr2_machine)
  set(pr2_machine_DEVEL_PREFIX /home/miguel/ws_moveit/devel/.private/pr2_machine)
  ...
  set(pr2_machine_INSTALL_PREFIX /home/miguel/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pr2_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/miguel/ws_moveit/src/pr2_common/pr2_machine/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/miguel/ws_moveit/devel/.private/pr2_machine/lib;/home/miguel/ws_moveit/devel/lib;/opt/ros/kinetic/lib)
